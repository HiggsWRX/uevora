...
pop(Pi,P):-
    escolheCi(Pi,Si,Ci,Pj),!, %cond
    escolheSk(Pj,Si,Ci,Pk), %passo
...
escolheSk(p(Passos,Ordem,Links),S,C,p([Sk-op(N,Cond,Add,Del)|Passos], [m(Sk,S),m(Sk,s2),m(s1,Sk)|Ordem], [link(Sk,S,C)|Links])):-
